    ...
    <section id="hero" className="min-h-screen pt-20 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 py-20 relative z-10 text-center max-w-4xl">
        ...
        <p className="text-lg md:text-xl text-slate-300 mb-12 max-w-3xl mx-auto leading-relaxed">
          Leading high-stakes infrastructure projects across North America and Europe. I align commercial strategy, delivery execution, and stakeholder trust to create long-term value, helping organizations thrive under complex alternative project delivery models with 20+ years in rail, highways, and transit megaprojects.
        </p>
